...
import { Text, Card, FAB, IconButton, Chip, Divider } from 'react-native-paper';
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              await dbService.deleteFoodEntry(id);
              await loadFoodEntries();
            } catch (error) {
      ...
      <Card.Content style={styles.entryContent}>
        <View style={styles.entryHeader}>
          <View style={styles.entryInfo}>
            <Text style={styles.entryTitle}>{entry.food_description}</Text>
